...
Router.configure({
  ...
  waitOn: function() { Meteor.subscribe('users');Meteor.subscribe('projects'); Meteor.subscribe('tags'); Meteor.subscribe('follows'); Meteor.subscribe('comments');Meteor.subscribe('sites');Meteor.subscribe("images"); Meteor.subscribe("files");Meteor.subscribe('notifications');Meteor.subscribe('teams');Meteor.subscribe('waters');Meteor.subscribe('weathers');Meteor.subscribe('chemicals');Meteor.subscribe('physicals');Meteor.subscribe('biologicals');}
//per all route?
});
